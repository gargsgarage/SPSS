...
public class AppTest {
    ...
    @Test
	public void testReadSubmissionsConcurrently(){
		SPSS cmsc132 = new SPSS(4);
		
		assertTrue(cmsc132.addStudent("shivam"));
		assertTrue(cmsc132.addStudent("larry"));
		assertTrue(cmsc132.addStudent("sally"));
		assertTrue(cmsc132.addStudent("doug"));
		
		assertTrue(cmsc132.readSubmissionsConcurrently(Arrays.asList("public11-input")));
		...
		assertEquals(shivamScore, cmsc132.score("shivam"));
		assertEquals(larryScore, cmsc132.score("larry"));
		assertEquals(sallyScore, cmsc132.score("sally"));
		assertEquals(dougScore, cmsc132.score("doug"));
	}
